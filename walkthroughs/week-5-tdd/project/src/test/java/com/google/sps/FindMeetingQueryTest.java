...
public final class FindMeetingQueryTest {
  ...
  private static final int TIME_0600AM = TimeRange.getTimeInMinutes(6, 00);
  private static final int TIME_0700AM = TimeRange.getTimeInMinutes(7, 00);
  ...
  public void everyAttendeeIsConsidered() {
    ...
    @Test
  public void everyAttendeeIsConsideredWithFutileOptionalAttendee() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
    ...
    @Test
  public void everyAttendeeIsConsideredWithViableOptionalAttendee() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
  ...
  @Test
  public void justEnoughRoomWithFutileOptionalAttendee() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0900AM, TimeRange.END_OF_DAY, true),
            Arrays.asList(PERSON_A)),
        new Event("Event 3", TimeRange.fromStartEnd(TIME_0830AM, TIME_0845AM, false), Arrays.asList(PERSON_B)));
  ...
  public void optionalAttendeesWithGaps() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TIME_0600AM, TIME_0700AM, false),
            Arrays.asList(PERSON_A)),
    ...
    Collection<TimeRange> actual = query.query(events, request);
    Collection<TimeRange> expected =
        Arrays.asList(TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0600AM, false),
            TimeRange.fromStartEnd(TIME_0700AM, TIME_0830AM, false),
            TimeRange.fromStartEnd(TIME_0845AM, TimeRange.END_OF_DAY, true));
